...
# -*- coding: utf-8 -*-
#
# DataCompare documentation build configuration file, created by
# sphinx-quickstart on Sat Feb 27 20:26:45 2016.
#
...
htmlhelp_basename = 'DataComparedoc'
...
latex_documents = [
  (master_doc, 'DataCompare.tex', 'DataCompare Documentation',
   'Josh Morel', 'manual'),
]
...
man_pages = [
    (master_doc, 'datacompare', 'DataCompare Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'DataCompare', 'DataCompare Documentation',
   author, 'DataCompare', 'One line description of project.',
   'Miscellaneous'),
]
