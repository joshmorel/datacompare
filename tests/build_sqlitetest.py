...
cursor.execute("INSERT INTO t1 VALUES (?,?,?,?,?,?,?)", 12,None,None,None,'sdafs',None,None)
cursor.execute("INSERT INTO t1 VALUES (?,?,?,?,?,?,?)", 13,1,1.0,'1.0','sdafs','2012-04-01 10:00',1)
cursor.commit()
...
cursor.execute("INSERT INTO t2 VALUES (?,?,?,?,?,?,?)", 12,None,None,None,'sdafdds',None,None)
cursor.execute("INSERT INTO t2 VALUES (?,?,?,?,?,?,?)", 13,None,None,None,None,None,None)
cursor.commit()
